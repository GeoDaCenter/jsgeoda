...
declare module 'jsgeoda' {
    import GeoDaWasm from "jsgeoda/geoda-proxy";
    
    export function New(): Promise<GeoDaWasm>;
}

declare module 'jsgeoda/geoda-proxy' {
    import GeoDaLisa from 'jsgeoda/geoda-lisa';
    import GeoDaWeights from 'jsgeoda/geoda-weights';
...
declare module 'jsgeoda/geoda-lisa' {
    /**
        * @class
...
declare module 'jsgeoda/geoda-weights' {
    /**
        * @class
