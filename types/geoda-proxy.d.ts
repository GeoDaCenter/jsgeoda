...
export default class GeoDaWasm {
     ...
     */
    getRookWeights(mapUid: string, order: number, includeLowerOrder: boolean, precisionThreshold: number): any;
    /**
     ...
     * @returns {Object} An instance of {@link GeoDaWeights}
     */
    getQueenWeights(mapUid: string, order: number, includeLowerOrder: boolean, precision: any): any;
    /**
     ...
     * @returns {Number}
     */
    getMinDistanceThreshold(mapUid: string, isArc: boolean, isMile: boolean): number;
    /**
     ...
     * @returns {Object} An instance of {@link GeoDaWeights}
     */
    getKnnWeights(mapUid: string, k: number, power: number, isInverse: boolean, isArc: boolean, isMile: boolean): any;
    /**
     ...
     * @returns {Object} An instance of {@link GeoDaWeights}
     */
    getDistanceWeights(mapUid: string, distThreshold: number, power: number, isInverse: boolean, isArc: boolean, isMile: boolean): any;
    /**
     ...
     * @returns {Object} An instance of {@link GeoDaWeights}
     */
    getKernelKnnWeights(mapUid: string, k: number, kernel: string, adaptiveBandwidth: boolean, useKernelDiagonals: boolean, power: number, isInverse: boolean, isArc: boolean, isMile: boolean): any;
    /**
     ...
     * @returns {Object} An instance of {@link GeoDaWeights}
     */
    getKernelWeights(mapUid: string, bandwidth: number, kernel: string, useKernelDiagonals: boolean, power: number, isInverse: boolean, isArc: boolean, isMile: boolean): any;
    /**
    ...
    */
     ...
     * @returns {Array}
     */
    spatialLag(weights: WeightsResult, values: any[], isBinary: boolean, rowStandardize: boolean, includeDiagonal: Bollean): any[];
    /**
     ...
     * @returns {Array}
     */
    spatialRate(weights: WeightsResult, eventValues: any[], baseValues: any[]): any[];
    /**
     ...
     * @returns {Array}
     */
    spatialEmpiricalBayes(weights: WeightsResult, eventValues: any[], baseValues: any[]): any[];
    /**
     ...
     */
    localMoran(weights: string, values: any[], permutations: number, permutationMethod: string, significanceCutoff: any, seed: number): any;
    /**
     ...
     * @returns {Object} An instance of {@link LisaResult}
     */
    localG(weights: string, values: any[], permutations: number, permutationMethod: string, significanceCutoff: any, seed: number): any;
    /**
     * Apply local G* statistics
     *
     * @param {String} weights The weights object {@link WeightsResult}
     ...
     * @returns {Object} An instance of {@link LisaResult}
     */
    localGStar(weights: string, values: any[], permutations: number, permutationMethod: string, significanceCutoff: any, seed: number): any;
    /**
     ...
     * @returns {Object} An instance of {@link LisaResult}
     */
    localGeary(weights: string, values: any[], permutations: number, permutationMethod: string, significanceCutoff: any, seed: number): any;
    /**
     ...
     * @returns {Object} An instance of {@link LisaResult}
     */
    localJoinCount(weights: string, values: any[], permutations: number, permutationMethod: string, significanceCutoff: any, seed: number): any;
    /**
     ...
     * @returns {Object} An instance of {@link LisaResult}
     */
    quantileLisa(weights: string, k: any, quantile: any, values: any[], permutations: number, permutationMethod: string, significanceCutoff: any, seed: number): any;
    /**
     ...
     * @returns {Object} An instance of {@link LisaResult}
     */
    callLisa(lisaFunction: any, weights: string, values: any[], permutations: number, permutationMethod: string, significanceCutoff: any, seed: number): any;
    /**
     ...
     */
    neighborMatchTest(mapUid: string, knn: number, data: any[], scaleMethod: string, distanceMethod: string, power: number, isInverse: boolean, isArc: boolean, isMile: boolean): any[];
    /**
     ...
     */
    localMultiGeary(weights: WeightsResult, values: any, permutations: number, permutationMethod: string, significanceCutoff: number, seed: number): any;
    /**
     ...
     * @returns {Object} LISA object {@link GeoDaLisa}
     */
    localBiJoinCount(weights: WeightsResult, values1: any[], values2: any[], permutations: number, permutationMethod: string, significanceCutoff: number, seed: number): any;
    /**
     ...
     * @returns {Object} LISA object {@link GeoDaLisa}
     */
    localMultiJoinCount(weights: WeightsResult, values: any[], permutations: number, permutationMethod: string, significanceCutoff: number, seed: number): any;
    /**
     ...
     * @returns {Object} LISA object {@link GeoDaLisa}
     */
    multiQuantileLisa(weights: WeightsResult, ks: any[], quantiles: any[], values: any[], permutations: number, permutationMethod: string, significanceCutoff: number, seed: number): any;
    /**
     ...
     */
    skater(weights: WeightsResult, k: number, values: any[], minBound: number, boundVals: any[], scaleMethod: string, distanceMethod: string): any;
    /**
     ...
     * {'total_ss', 'within_ss', 'between_ss', 'ratio', 'clusters'}
     */
    redcap(weights: WeightsResult, k: number, values: any[], method: string, minBound: number, boundVals: any[], scaleMethod: string, distanceMethod: string): any;
    /**
     ...
     * {'total_ss', 'within_ss', 'between_ss', 'ratio', 'clusters'}
     */
    schc(weights: WeightsResult, k: number, values: any[], method: string, minBound: number, boundVals: any[], scaleMethod: string, distanceMethod: string): any;
    /**
     ...
     * {'total_ss', 'within_ss', 'between_ss', 'ratio', 'clusters'}
     */
    azpGreedy(weights: WeightsResult, k: number, values: any[], inits: number, initRegion: any[], minBoundValues: any[], minBounds: any[], maxBoundValues: any[], maxBounds: any[], scaleMethod: string, distanceMethod: string, seed: number): any;
    /**
     ...
     * {'total_ss', 'within_ss', 'between_ss', 'ratio', 'clusters'}
     */
    azpSA(weights: WeightsResult, k: number, values: any[], coolingRate: number, saMaxIt: number, inits: number, initRegion: any[], minBoundValues: any[], minBounds: any[], maxBoundValues: any[], maxBounds: any[], scaleMethod: string, distanceMethod: string, seed: number): any;
    /**
     ...
     * {'total_ss', 'within_ss', 'between_ss', 'ratio', 'clusters'}
     */
    azpTabu(weights: WeightsResult, k: number, values: any[], tabuLength: number, convTabu: number, inits: number, initRegion: any[], minBoundValues: any[], minBounds: any[], maxBoundValues: any[], maxBounds: any[], scaleMethod: string, distanceMethod: string, seed: number): any;
    /**
     ...
     * {'total_ss', 'within_ss', 'between_ss', 'ratio', 'clusters'}
     */
    maxpGreedy(weights: WeightsResult, values: any[], iterations: number, minBoundValues: any[], minBounds: any[], maxBoundValues: any[], maxBounds: any[], scaleMethod: string, distanceMethod: string, seed: number): any;
    /**
     ...
     * {'total_ss', 'within_ss', 'between_ss', 'ratio', 'clusters'}
     */
    maxpSA(weights: WeightsResult, values: any[], coolingRate: number, saMaxIt: number, iterations: number, minBoundValues: any[], minBounds: any[], maxBoundValues: any[], maxBounds: any[], scaleMethod: string, distanceMethod: string, seed: number): any;
    /**
     ...
     * {'total_ss', 'within_ss', 'between_ss', 'ratio', 'clusters'}
     */
    maxpTabu(weights: WeightsResult, values: any[], tabuLength: number, convTabu: number, iterations: number, minBoundValues: any[], minBounds: any[], maxBoundValues: any[], maxBounds: any[], scaleMethod: string, distanceMethod: string, seed: number): any;
}
